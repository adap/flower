...
* **Minor updates**
    ...
    * Expose Flower version through "flwr.__version__" (`#952 <https://github.com/adap/flower/pull/952>`_)#974
    * :code:`start_server` in :code:`app.py` now return a :code:`History` object containing metrics from training (`#974 <https://github.com/adap/flower/pull/974>`_)
