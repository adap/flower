...
def read_jsons_and_save(list_jsons: List[PathLike], save_root: PathLike,
...
def split_json_and_save(list_datasets: List[Tuple[str, float]], paths_to_json: List[PathLike],
                        save_root: PathLike):
...
if __name__ == '__main__':
    ...
    parser.add_argument('--leaf_train_jsons_root', type=str, required=True,
                    help='Root directory to JSON files containing the generated trainset for LEAF FEMNIST.')
    ...
    parser.add_argument('--leaf_test_jsons_root', type=str, required=True,
                    help='Root folder to JSON file containing the generated *testset* for LEAF FEMNIST.')
    ...
    original_train_datasets = sorted(list( Path(args.leaf_train_jsons_root).glob('**/*.json') ))
    ...
    original_test_datasets = sorted(list( Path(args.leaf_test_jsons_root).glob('**/*.json') ))
