"""Runs 2NN MLP federated learning for MNIST dataset."""
...
from flwr_baselines.publications.fedavg_mnist_2nn import client, utils
...
def main(cfg: DictConfig) -> None:
    """Main function to run 2NN MLP federated learning on MNIST.
