...
class FedAvgWithStragglerDrop(FedAvg):
    """My customised FedAvg strategy which discards
    updates sent by clients that were flagged as stragglers.
    """

    def aggregate_fit(self, server_round: int,
                      results: List[Tuple[ClientProxy, FitRes]],
                      failures: List[Union[Tuple[ClientProxy, FitRes], BaseException]]):
        """Here we discard all the models sent by the clients that
        were stragglers in this round."""
