...
from flwr_baselines.publications.fedprox_mnist.dataset_preparation import (
    _partition_data,
)
...
def load_datasets(  # pylint: disable=too-many-arguments
    ...
    datasets, testset = _partition_data(
        num_clients, config.iid, config.power_law, config.balance, seed
    )
    ...
    for dataset in datasets:
        ...
        trainloaders.append(
            DataLoader(ds_train, batch_size=batch_size, shuffle=True, num_workers=2)
        )
