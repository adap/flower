...
class FedMLBModel(tf.keras.Model):
    ...
    def compile(self, optimizer, loss, metrics, kd_loss, lambda_1=0.1, lambda_2=0.3):
        super(FedMLBModel, self).compile(optimizer=optimizer, loss=loss, metrics=metrics)
    ...
    def train_step(self, data):
        ...
        with tf.GradientTape() as tape:
            ...
            ce_loss = self.compiled_loss(y, logits, regularization_losses=self.local_model.losses)
