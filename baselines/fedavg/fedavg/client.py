...
class FlowerClient(fl.client.NumPyClient):
    ...
    def __init__(
        ...
        self.evaluate_fn = client_cfg.evaluate_fn
    ...
    def evaluate(
        ...
        self.set_parameters(parameters)
        loss, accuracy = call(self.evaluate_fn, self.net, self.valloader, self.device)
...
def gen_client_fn(
    ...
    def client_fn(cid: str) -> FlowerClient:
        ...
        return FlowerClient(net, trainloader, valloader, client_cfg)
