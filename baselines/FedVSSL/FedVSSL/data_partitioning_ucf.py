...
def parse_args():
    ...
    parser.add_argument('--json_path', default='/path/to/ucf101/annotations', type=str,
                        help='directory path to training .json files.')
    parser.add_argument('--output_path', default='/path/to/ucf101/annotations/annotations_fed',
                        type=str, help='output path for generated clients .json files.')
    parser.add_argument('--num_clients', default=10, type=int, help='number of clients for partitioning.')
