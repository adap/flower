...
class FlowerClient(fl.client.NumPyClient):
    def __init__(self,cid,trainloader,testloader,cfg) -> None:
        ...
        self.net = CNNTarget(in_channels=cfg.model.in_channels, n_kernels=self.n_kernels, out_dim=cfg.model.out_dim)
       
    def set_parameters(self,parameters):
        """Setting the target network parameters using the parameters from the server"""
    ...
    def fit(self,parameters, config):
        ...
        train(self.net,self.trainloader,self.testloader,self.epochs,self.lr,self.wd,self.device,self.cid)
