...
const mockFitIns: FitIns = {
  parameters: mockParameters,
  config: { key1: mockScalar },
};
...
const mockEvaluateIns: EvaluateIns = {
  parameters: mockParameters,
  config: { key3: mockScalar },
};
...
describe('RecordSet Compatibility Functions', () => {
  ...
  it('should convert recordset to GetParametersIns', () => {
    const recordset = getParametersInsToRecordSet({
      config: { key6: mockScalar },
    });
  ...
  it('should convert recordset to GetPropertiesIns', () => {
    const recordset = getPropertiesInsToRecordSet({
      config: { key7: mockScalar },
    });
