...
export default function ChatPage() {
  ...
  return (
    <div className="flex flex-col min-h-[calc(100vh-60px)] border rounded shadow bg-white dark:bg-gray-800">
      {/* Chat Messages */}
      <div className="flex-grow p-4 overflow-auto">
        {chatLog.map((entry, index) => (
          ...
          >
            ...
            >
              {/* Use ReactMarkdown to parse and display Markdown */}
              <div className="prose prose-sm sm:prose md:prose-lg lg:prose-xl break-words">
