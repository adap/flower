...
fileprivate struct SubmitClientPublicKeyResponse: Codable {
    let expiresAt: Date
...
fileprivate struct GetServerPublicKeyResponse: Codable {
    ...
    init(from decoder: Decoder) throws {
        ...
        guard let decodedData = Data(base64Encoded: base64String) else {
            throw DecodingError.dataCorruptedError(forKey: .publicKeyBase64, in: container, debugDescription: "Invalid Base64 string")
        }
