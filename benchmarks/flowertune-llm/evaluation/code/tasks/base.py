# This python file is adapted from https://github.com/bigcode-project/bigcode-evaluation-harness/blob/main/bigcode_eval/base.py
...
class Task(ABC):
    ...
    def process_results(self, generations, references):
        ...
        references, returning the metric for the generations as in {"metric_name":
        result}.
    ...
    def _stop_at_stop_token(decoded_string, stop_tokens):
        """Produces the prefix of decoded_string that ends at the first occurrence of a
        stop_token.
