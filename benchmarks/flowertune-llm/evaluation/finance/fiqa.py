# This python file is adapted from https://github.com/AI4Finance-Foundation/FinGPT/blob/master/fingpt/FinGPT_Benchmark/benchmarks/fiqa.py
...
from utils import change_target, format_example, save_results
