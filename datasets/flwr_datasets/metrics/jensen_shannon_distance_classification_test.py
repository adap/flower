...
# ==============================================================================
"""JensenShannonDistanceClassification tests."""
...
from flwr_datasets.metrics.jensen_shannon_distance_classification import (
    JensenShannonDistanceClassification,
)


class TestJensenShannonDistanceClassification(unittest.TestCase):
    """Test JensenShannonDistanceClassification."""
    ...
    def test_edge_case_lowest_distance(self) -> None:
        ...
        JSD = JensenShannonDistanceClassification(dummy_targets_lists)
    ...
    def test_target_integer(self) -> None:
        ...
        JSD = JensenShannonDistanceClassification(random_targets_lists)
