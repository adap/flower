...
# ==============================================================================
"""JensenShannonDistanceRegression tests."""

import unittest

import numpy as np

from flwr_datasets.metrics.jensen_shannon_distance_regression import (
    JensenShannonDistanceRegression,
)


class TestJensenShannonDistanceRegression(unittest.TestCase):
    """Test JensenShannonDistanceRegression."""
    ...
    def test_edge_case_lowest_distance(self) -> None:
        ...
        JSD = JensenShannonDistanceRegression(dummy_targets_lists, num_bins=2)
    ...
    def test_correctness_low_non_IID_ness(self) -> None:
        ...
        JSD = JensenShannonDistanceRegression(dummy_targets_lists, num_bins=3)

        self.assertEqual(JSD, 0.2515432420035073)
    ...
    def test_correctness_high_non_IID_ness(self) -> None:
        ...
        JSD = JensenShannonDistanceRegression(dummy_targets_lists, num_bins=20)

        self.assertEqual(JSD, 0.8345801007005303)
    ...
    def test_target_integer(self) -> None:
        ...
        JSD = JensenShannonDistanceRegression(random_targets_lists, num_bins=3)
