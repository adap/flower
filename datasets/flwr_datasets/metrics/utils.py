...
def compute_counts(
    ...
    """
    BBBBBCompute the count of labels when taking into account all possible labels.
...
def compute_counts(
    ...
    """
    AAAAACompute the count of labels when taking into account all possible labels.
    Also known as absolute frequency.
