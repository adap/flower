...
class GetFederationOptionsResponse final :
 ...
 public:
  ...
  const ::flwr::proto::ConfigsRecord& federation_options() const;
  PROTOBUF_MUST_USE_RESULT ::flwr::proto::ConfigsRecord* release_federation_options();
  ::flwr::proto::ConfigsRecord* mutable_federation_options();
  void set_allocated_federation_options(::flwr::proto::ConfigsRecord* federation_options);
  private:
  const ::flwr::proto::ConfigsRecord& _internal_federation_options() const;
  ::flwr::proto::ConfigsRecord* _internal_mutable_federation_options();
  public:
  void unsafe_arena_set_allocated_federation_options(
      ::flwr::proto::ConfigsRecord* federation_options);
  ::flwr::proto::ConfigsRecord* unsafe_arena_release_federation_options();
 ...
 private:
  ...
  typedef void InternalArenaConstructable_;
  typedef void DestructorSkippable_;
  ::flwr::proto::ConfigsRecord* federation_options_;
  mutable ::PROTOBUF_NAMESPACE_ID::internal::CachedSize _cached_size_;
  friend struct ::TableStruct_flwr_2fproto_2frun_2eproto;
};
// ===================================================================
...
inline const ::flwr::proto::ConfigsRecord& GetFederationOptionsResponse::_internal_federation_options() const {
  const ::flwr::proto::ConfigsRecord* p = federation_options_;
  return p != nullptr ? *p : reinterpret_cast<const ::flwr::proto::ConfigsRecord&>(
      ::flwr::proto::_ConfigsRecord_default_instance_);
}
inline const ::flwr::proto::ConfigsRecord& GetFederationOptionsResponse::federation_options() const {
...
inline ::flwr::proto::ConfigsRecord* GetFederationOptionsResponse::release_federation_options() {
  
  ::flwr::proto::ConfigsRecord* temp = federation_options_;
...
inline ::flwr::proto::ConfigsRecord* GetFederationOptionsResponse::unsafe_arena_release_federation_options() {
...
inline ::flwr::proto::ConfigsRecord* GetFederationOptionsResponse::_internal_mutable_federation_options() {
  
  if (federation_options_ == nullptr) {
    auto* p = CreateMaybeMessage<::flwr::proto::ConfigsRecord>(GetArenaForAllocation());
    federation_options_ = p;
  }
  return federation_options_;
}
inline ::flwr::proto::ConfigsRecord* GetFederationOptionsResponse::mutable_federation_options() {
  ::flwr::proto::ConfigsRecord* _msg = _internal_mutable_federation_options();
  // @@protoc_insertion_point(field_mutable:flwr.proto.GetFederationOptionsResponse.federation_options)
  return _msg;
}
inline void GetFederationOptionsResponse::set_allocated_federation_options(::flwr::proto::ConfigsRecord* federation_options) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArenaForAllocation();
  if (message_arena == nullptr) {
    delete reinterpret_cast< ::PROTOBUF_NAMESPACE_ID::MessageLite*>(federation_options_);
  }
