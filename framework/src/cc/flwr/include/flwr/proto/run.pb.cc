...
const char descriptor_table_protodef_flwr_2fproto_2frun_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "ue\030\002 \001(\0132\022.flwr.proto.Scalar:\0028\001\"@\n\tRunS"
  "tatus\022\016\n\006status\030\001 \001(\t\022\022\n\nsub_status\030\002 \001("
  "\t\022\017\n\007details\030\003 \001(\t\"\353\001\n\020CreateRunRequest\022"
  "\016\n\006fab_id\030\001 \001(\t\022\023\n\013fab_version\030\002 \001(\t\022I\n\017"
  "override_config\030\003 \003(\01320.flwr.proto.Creat"
  "eRunRequest.OverrideConfigEntry\022\034\n\003fab\030\004"
  " \001(\0132\017.flwr.proto.Fab\032I\n\023OverrideConfigE"
  ...
  " \001(\0132\020.flwr.proto.Node\022\016\n\006run_id\030\002 \001(\004\"."
  "\n\016GetRunResponse\022\034\n\003run\030\001 \001(\0132\017.flwr.pro"
  "to.Run\"S\n\026UpdateRunStatusRequest\022\016\n\006run_"
  "id\030\001 \001(\004\022)\n\nrun_status\030\002 \001(\0132\025.flwr.prot"
  "o.RunStatus\"\031\n\027UpdateRunStatusResponse\"F"
  "\n\023GetRunStatusRequest\022\036\n\004node\030\001 \001(\0132\020.fl"
  "wr.proto.Node\022\017\n\007run_ids\030\002 \003(\004\"\261\001\n\024GetRu"
  "nStatusResponse\022L\n\017run_status_dict\030\001 \003(\013"
  "23.flwr.proto.GetRunStatusResponse.RunSt"
  "atusDictEntry\032K\n\022RunStatusDictEntry\022\013\n\003k"
  "ey\030\001 \001(\004\022$\n\005value\030\002 \001(\0132\025.flwr.proto.Run"
  "Status:\0028\001\"-\n\033GetFederationOptionsReques"
  "t\022\016\n\006run_id\030\001 \001(\004\"U\n\034GetFederationOption"
  "sResponse\0225\n\022federation_options\030\001 \001(\0132\031."
  "flwr.proto.ConfigsRecordb\006proto3"
  ;
...
class GetFederationOptionsResponse::_Internal {
 public:
  static const ::flwr::proto::ConfigsRecord& federation_options(const GetFederationOptionsResponse* msg);
};

const ::flwr::proto::ConfigsRecord&
...
GetFederationOptionsResponse::GetFederationOptionsResponse(const GetFederationOptionsResponse& from)
  ...
  if (from._internal_has_federation_options()) {
    federation_options_ = new ::flwr::proto::ConfigsRecord(*from.federation_options_);
  } else {
    federation_options_ = nullptr;
  }
...
#define CHK_(x) if (PROTOBUF_PREDICT_FALSE(!(x))) goto failure
  while (!ctx->Done(&ptr)) {
    ...
    ptr = ::PROTOBUF_NAMESPACE_ID::internal::ReadTag(ptr, &tag);
    switch (tag >> 3) {
      // .flwr.proto.ConfigsRecord federation_options = 1;
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 10)) {
...
// @@protoc_insertion_point(class_specific_merge_from_start:flwr.proto.GetFederationOptionsResponse)
  ...
  if (from._internal_has_federation_options()) {
    _internal_mutable_federation_options()->::flwr::proto::ConfigsRecord::MergeFrom(from._internal_federation_options());
  }
  _internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
}
