...
class AddNodeResponse(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["_node",b"_node","node",b"node"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["_node",b"_node","node",b"node"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["_node",b"_node"]) -> typing.Optional[typing_extensions.Literal["node"]]: ...
