...
SUPERNODE_COULD_NOT_BE_ADDED_TO_FEDERATION_MESSAGE = (
    "One or more SuperNodes could not be added to the federation. Ensure all node IDs are "
...
SUPERNODE_COULD_NOT_BE_REMOVED_FROM_FEDERATION_MESSAGE = (
    "One or more SuperNodes could not be removed from the federation. Ensure all node IDs "
