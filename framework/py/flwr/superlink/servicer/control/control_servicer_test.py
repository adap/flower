...
from flwr.common.typing import AccountInfo, Run, RunStatus
...
class TestControlServicer(unittest.TestCase):
    ...
    def setUp(self) -> None:
        ...
        self.servicer = ControlServicer(
            ...
            is_simulation=False,
            auth_plugin=(auth_plugin := NoOpControlAuthnPlugin(Mock(), False)),
        )
        account_info: AccountInfo = auth_plugin.validate_tokens_in_metadata([])[1]
