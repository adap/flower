...
.. note::
    ...
    <https://github.com/flwrlabs/flower/blob/main/hub/apps/xgboost-quickstart>`_ of the
    extended version of this tutorial in ``hub/apps/xgboost-quickstart`` in the Flower
    GitHub repository.
