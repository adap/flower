...
- `latest`
  - points to `1.19.0` and `1.19.0-py3.12-ubuntu24.04`
  - uses Python 3.12 and Ubuntu 24.04
- `unstable`
  - points to the last successful build of the `main` branch
- `nightly`, `<version>.dev<YYYYMMDD>` e.g. `1.20.0.dev20250714`
  - uses Python 3.12 and Ubuntu 24.04
- `1.19.0`, `1.19.0-py3.12-ubuntu24.04`, `latest`
- `1.19.0-py3.11-ubuntu24.04`
- `1.19.0-py3.10-ubuntu24.04`
- `1.19.0-py3.9-ubuntu24.04`
- `1.18.0`, `1.18.0-py3.12-ubuntu24.04`
