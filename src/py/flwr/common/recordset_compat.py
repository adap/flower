...
def _recordset_to_fit_or_evaluate_ins_components(
    ...
    parameters_record = recordset.params_dict[f"{ins_str}.parameters"]
...
def _fit_or_evaluate_ins_to_recordset(
    ...
    recordset.params_dict[f"{ins_str}.parameters"] = parameters_to_parametersrecord(
        ins.parameters,
        keep_input,
    )
...
def recordset_to_fitres(recordset: RecordSet, keep_input: bool) -> FitRes:
    ...
    ins_str = "fitres"
    parameters = parametersrecord_to_parameters(
        recordset.params_dict[f"{ins_str}.parameters"], keep_input=keep_input
    )
...
def fitres_to_recordset(fitres: FitRes, keep_input: bool) -> RecordSet:
    ...
    recordset.params_dict[f"{res_str}.parameters"] = parameters_to_parametersrecord(
        fitres.parameters,
        keep_input,
    )
...
def getparametersres_to_recordset(
    ...
    recordset.params_dict[f"{res_str}.parameters"] = parameters_record
...
def recordset_to_getparametersres(
    ...
    res_str = "getparametersres"
    parameters = parametersrecord_to_parameters(
        recordset.params_dict[f"{res_str}.parameters"], keep_input=keep_input
    )
