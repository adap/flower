...
_SERVERMESSAGE_GETCONFIG_CONFIGENTRY = _descriptor.Descriptor(
  name='ConfigEntry',
  full_name='flower.transport.ServerMessage.GetConfig.ConfigEntry',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='key', full_name='flower.transport.ServerMessage.GetConfig.ConfigEntry.key', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='value', full_name='flower.transport.ServerMessage.GetConfig.ConfigEntry.value', index=1,
      number=2, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_SERVERMESSAGE_GETCONFIG = _descriptor.Descriptor(
  name='GetConfig',
  full_name='flower.transport.ServerMessage.GetConfig',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='config', full_name='flower.transport.ServerMessage.GetConfig.config', index=0,
  ...
  nested_types=[_SERVERMESSAGE_GETCONFIG_CONFIGENTRY, ],
  enum_types=[
  ],
  serialized_options=None,
  is_extendable=False,
...
_SERVERMESSAGE = _descriptor.Descriptor(
  ...
  nested_types=[_SERVERMESSAGE_RECONNECT, _SERVERMESSAGE_GETPARAMETERS, _SERVERMESSAGE_FITINS, _SERVERMESSAGE_EVALUATEINS, _SERVERMESSAGE_GETCONFIG, ],
  enum_types=[
  ],
  serialized_options=None,
  is_extendable=False,
...
_CLIENTMESSAGE_GETINFO_INFOENTRY = _descriptor.Descriptor(
  name='InfoEntry',
  full_name='flower.transport.ClientMessage.GetInfo.InfoEntry',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='key', full_name='flower.transport.ClientMessage.GetInfo.InfoEntry.key', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='value', full_name='flower.transport.ClientMessage.GetInfo.InfoEntry.value', index=1,
      number=2, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_CLIENTMESSAGE_GETINFO = _descriptor.Descriptor(
  name='GetInfo',
  full_name='flower.transport.ClientMessage.GetInfo',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='info', full_name='flower.transport.ClientMessage.GetInfo.info', index=0,
      number=1, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
  ...
  nested_types=[_CLIENTMESSAGE_GETINFO_INFOENTRY, ],
  enum_types=[
  ],
  serialized_options=None,
  is_extendable=False,
...
_CLIENTMESSAGE = _descriptor.Descriptor(
  ...
  nested_types=[_CLIENTMESSAGE_DISCONNECT, _CLIENTMESSAGE_PARAMETERSRES, _CLIENTMESSAGE_FITRES, _CLIENTMESSAGE_EVALUATERES, _CLIENTMESSAGE_GETINFO, ],
  enum_types=[
  ],
  serialized_options=None,
  is_extendable=False,
...
_SERVERMESSAGE_GETCONFIG_CONFIGENTRY.fields_by_name['value'].message_type = _SCALAR
_SERVERMESSAGE_GETCONFIG_CONFIGENTRY.containing_type = _SERVERMESSAGE_GETCONFIG
_SERVERMESSAGE_GETCONFIG.fields_by_name['config'].message_type = _SERVERMESSAGE_GETCONFIG_CONFIGENTRY
_SERVERMESSAGE_GETCONFIG.containing_type = _SERVERMESSAGE
...
_CLIENTMESSAGE_GETINFO_INFOENTRY.fields_by_name['value'].message_type = _SCALAR
_CLIENTMESSAGE_GETINFO_INFOENTRY.containing_type = _CLIENTMESSAGE_GETINFO
_CLIENTMESSAGE_GETINFO.fields_by_name['info'].message_type = _CLIENTMESSAGE_GETINFO_INFOENTRY
_CLIENTMESSAGE_GETINFO.containing_type = _CLIENTMESSAGE
...
ServerMessage = _reflection.GeneratedProtocolMessageType('ServerMessage', (_message.Message,), {
  ...
  'GetConfig' : _reflection.GeneratedProtocolMessageType('GetConfig', (_message.Message,), {
    ...
    'ConfigEntry' : _reflection.GeneratedProtocolMessageType('ConfigEntry', (_message.Message,), {
      'DESCRIPTOR' : _SERVERMESSAGE_GETCONFIG_CONFIGENTRY,
      '__module__' : 'flwr.proto.transport_pb2'
      # @@protoc_insertion_point(class_scope:flower.transport.ServerMessage.GetConfig.ConfigEntry)
      })
    ,
    'DESCRIPTOR' : _SERVERMESSAGE_GETCONFIG,
    '__module__' : 'flwr.proto.transport_pb2'
    # @@protoc_insertion_point(class_scope:flower.transport.ServerMessage.GetConfig)
    })
  ,
...
_sym_db.RegisterMessage(ServerMessage.GetConfig)
_sym_db.RegisterMessage(ServerMessage.GetConfig.ConfigEntry)
...
ClientMessage = _reflection.GeneratedProtocolMessageType('ClientMessage', (_message.Message,), {
  ...
  'GetInfo' : _reflection.GeneratedProtocolMessageType('GetInfo', (_message.Message,), {
    ...
    'InfoEntry' : _reflection.GeneratedProtocolMessageType('InfoEntry', (_message.Message,), {
      'DESCRIPTOR' : _CLIENTMESSAGE_GETINFO_INFOENTRY,
      '__module__' : 'flwr.proto.transport_pb2'
      # @@protoc_insertion_point(class_scope:flower.transport.ClientMessage.GetInfo.InfoEntry)
      })
    ,
    'DESCRIPTOR' : _CLIENTMESSAGE_GETINFO,
    '__module__' : 'flwr.proto.transport_pb2'
    # @@protoc_insertion_point(class_scope:flower.transport.ClientMessage.GetInfo)
    })
  ,
...
_sym_db.RegisterMessage(ClientMessage.GetInfo)
_sym_db.RegisterMessage(ClientMessage.GetInfo.InfoEntry)
...
_SERVERMESSAGE_GETCONFIG_CONFIGENTRY._options = None
...
_CLIENTMESSAGE_GETINFO_INFOENTRY._options = None
