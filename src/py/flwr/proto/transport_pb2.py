...
_REASON = _descriptor.EnumDescriptor(
    ...
    values=[
        ...
        _descriptor.EnumValueDescriptor(
            name="RECONNECT", index=1, number=1, serialized_options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
        ...
        _descriptor.EnumValueDescriptor(
            name="ACK", index=4, number=4, serialized_options=None, type=None
        ),
    ],
...
_PARAMETERS = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="tensors",
            full_name="flower.transport.Parameters.tensors",
            index=0,
            number=1,
            type=12,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="tensor_type",
            full_name="flower.transport.Parameters.tensor_type",
            index=1,
            number=2,
            type=9,
            cpp_type=9,
...
_SERVERMESSAGE_RECONNECT = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="seconds",
            full_name="flower.transport.ServerMessage.Reconnect.seconds",
            index=0,
            number=1,
            type=3,
            cpp_type=2,
...
_SERVERMESSAGE_FITINS_CONFIGENTRY = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="key",
            full_name="flower.transport.ServerMessage.FitIns.ConfigEntry.key",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="value",
            full_name="flower.transport.ServerMessage.FitIns.ConfigEntry.value",
            index=1,
            number=2,
            type=9,
            cpp_type=9,
...
_SERVERMESSAGE_FITINS = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="parameters",
            full_name="flower.transport.ServerMessage.FitIns.parameters",
            index=0,
            number=1,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="config",
            full_name="flower.transport.ServerMessage.FitIns.config",
            index=1,
            number=2,
            type=11,
            cpp_type=10,
...
_SERVERMESSAGE_EVALUATEINS_CONFIGENTRY = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="key",
            full_name="flower.transport.ServerMessage.EvaluateIns.ConfigEntry.key",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="value",
            full_name="flower.transport.ServerMessage.EvaluateIns.ConfigEntry.value",
            index=1,
            number=2,
            type=9,
            cpp_type=9,
...
_SERVERMESSAGE_EVALUATEINS = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="parameters",
            full_name="flower.transport.ServerMessage.EvaluateIns.parameters",
            index=0,
            number=1,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="config",
            full_name="flower.transport.ServerMessage.EvaluateIns.config",
            index=1,
            number=2,
            type=11,
            cpp_type=10,
...
_SERVERMESSAGE = _descriptor.Descriptor(
    ...
    fields=[
        ...
        _descriptor.FieldDescriptor(
            name="get_parameters",
            full_name="flower.transport.ServerMessage.get_parameters",
            index=1,
            number=2,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="fit_ins",
            full_name="flower.transport.ServerMessage.fit_ins",
            index=2,
            number=3,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="evaluate_ins",
            full_name="flower.transport.ServerMessage.evaluate_ins",
            index=3,
            number=4,
            type=11,
            cpp_type=10,
    ...
    extensions=[],
    nested_types=[
        _SERVERMESSAGE_RECONNECT,
        _SERVERMESSAGE_GETPARAMETERS,
        _SERVERMESSAGE_FITINS,
    ...
    oneofs=[
        _descriptor.OneofDescriptor(
            name="msg",
            full_name="flower.transport.ServerMessage.msg",
            index=0,
            containing_type=None,
            fields=[],
        ),
...
_CLIENTMESSAGE_DISCONNECT = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="reason",
            full_name="flower.transport.ClientMessage.Disconnect.reason",
            index=0,
            number=1,
            type=14,
            cpp_type=8,
...
_CLIENTMESSAGE_PARAMETERSRES = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="parameters",
            full_name="flower.transport.ClientMessage.ParametersRes.parameters",
            index=0,
            number=1,
            type=11,
            cpp_type=10,
...
_CLIENTMESSAGE_FITRES = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="parameters",
            full_name="flower.transport.ClientMessage.FitRes.parameters",
            index=0,
            number=1,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="num_examples",
            full_name="flower.transport.ClientMessage.FitRes.num_examples",
            index=1,
            number=2,
            type=3,
            cpp_type=2,
        ...
        _descriptor.FieldDescriptor(
            name="num_examples_ceil",
            full_name="flower.transport.ClientMessage.FitRes.num_examples_ceil",
            index=2,
            number=3,
            type=3,
            cpp_type=2,
        ...
        _descriptor.FieldDescriptor(
            name="fit_duration",
            full_name="flower.transport.ClientMessage.FitRes.fit_duration",
            index=3,
            number=4,
            type=2,
            cpp_type=6,
...
_CLIENTMESSAGE_EVALUATERES = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="num_examples",
            full_name="flower.transport.ClientMessage.EvaluateRes.num_examples",
            index=0,
            number=1,
            type=3,
            cpp_type=2,
        ...
        _descriptor.FieldDescriptor(
            name="loss",
            full_name="flower.transport.ClientMessage.EvaluateRes.loss",
            index=1,
            number=2,
            type=2,
            cpp_type=6,
        ...
        _descriptor.FieldDescriptor(
            name="accuracy",
            full_name="flower.transport.ClientMessage.EvaluateRes.accuracy",
            index=2,
            number=3,
            type=2,
            cpp_type=6,
...
_CLIENTMESSAGE = _descriptor.Descriptor(
    ...
    fields=[
        ...
        _descriptor.FieldDescriptor(
            name="parameters_res",
            full_name="flower.transport.ClientMessage.parameters_res",
            index=1,
            number=2,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="fit_res",
            full_name="flower.transport.ClientMessage.fit_res",
            index=2,
            number=3,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="evaluate_res",
            full_name="flower.transport.ClientMessage.evaluate_res",
            index=3,
            number=4,
            type=11,
            cpp_type=10,
    ...
    oneofs=[
        _descriptor.OneofDescriptor(
            name="msg",
            full_name="flower.transport.ClientMessage.msg",
            index=0,
            containing_type=None,
            fields=[],
        ),
...
_SERVERMESSAGE_FITINS.fields_by_name[
    "config"
].message_type = _SERVERMESSAGE_FITINS_CONFIGENTRY
...
_SERVERMESSAGE_EVALUATEINS.fields_by_name[
    "config"
].message_type = _SERVERMESSAGE_EVALUATEINS_CONFIGENTRY
...
_SERVERMESSAGE.fields_by_name[
    "get_parameters"
].message_type = _SERVERMESSAGE_GETPARAMETERS
...
_CLIENTMESSAGE.fields_by_name[
    "parameters_res"
].message_type = _CLIENTMESSAGE_PARAMETERSRES
...
ServerMessage = _reflection.GeneratedProtocolMessageType(
    ...
    (_message.Message,),
    {
        ...
        "GetParameters": _reflection.GeneratedProtocolMessageType(
            "GetParameters",
            (_message.Message,),
            {
...
ClientMessage = _reflection.GeneratedProtocolMessageType(
    ...
    (_message.Message,),
    {
        "Disconnect": _reflection.GeneratedProtocolMessageType(
            "Disconnect",
            (_message.Message,),
            {
        ...
        "ParametersRes": _reflection.GeneratedProtocolMessageType(
            "ParametersRes",
            (_message.Message,),
            {
