...
_SERVERMESSAGE_SECAGGMSG_ASKVECTORS = _descriptor.Descriptor(
  ...
  nested_types=[_SERVERMESSAGE_SECAGGMSG_ASKVECTORS_PACKET, ],
  enum_types=[
  ],
  serialized_options=None,
  is_extendable=False,
