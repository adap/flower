...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _globals['_GETFABREQUEST']._serialized_end=198
  _globals['_GETFABRESPONSE']._serialized_start=200
  _globals['_GETFABRESPONSE']._serialized_end=246
