...
class GetFabRequest(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["_run_id",b"_run_id","node",b"node","run_id",b"run_id"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["_run_id",b"_run_id","hash_str",b"hash_str","node",b"node","run_id",b"run_id"]) -> None: ...
