...
class ClientAppIoStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetFab = channel.unary_unary(
                '/flwr.proto.ClientAppIo/GetFab',
                request_serializer=flwr_dot_proto_dot_clientappio__pb2.GetFabRequestWithToken.SerializeToString,
...
def add_ClientAppIoServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'GetFab': grpc.unary_unary_rpc_method_handler(
                    servicer.GetFab,
                    request_deserializer=flwr_dot_proto_dot_clientappio__pb2.GetFabRequestWithToken.FromString,
...
class ClientAppIo(object):
    ...
    def GetFab(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/flwr.proto.ClientAppIo/GetFab',
            flwr_dot_proto_dot_clientappio__pb2.GetFabRequestWithToken.SerializeToString,
