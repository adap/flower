...
class ServerAppIoServicer(metaclass=abc.ABCMeta):
    ...
    def PushTaskIns(
        ...
        context: _ServicerContext,
    ) -> typing.Union[flwr.proto.serverappio_pb2.PushTaskInsResponse, collections.abc.Awaitable[flwr.proto.serverappio_pb2.PushTaskInsResponse]]:
        """Create one or more tasks"""
    ...
    def PullTaskRes(
        ...
        context: _ServicerContext,
    ) -> typing.Union[flwr.proto.serverappio_pb2.PullTaskResResponse, collections.abc.Awaitable[flwr.proto.serverappio_pb2.PullTaskResResponse]]:
        """Get task results"""
