...
class ServerMessage(google.protobuf.message.Message):
    ...
    class SecAggMsg(google.protobuf.message.Message):
        ...
        class SetupParam(google.protobuf.message.Message):
            DESCRIPTOR: google.protobuf.descriptor.Descriptor = ...
            class ParamDictEntry(google.protobuf.message.Message):
                DESCRIPTOR: google.protobuf.descriptor.Descriptor = ...
                KEY_FIELD_NUMBER: builtins.int
                VALUE_FIELD_NUMBER: builtins.int
                key: typing.Text = ...
            ...
            PARAM_DICT_FIELD_NUMBER: builtins.int

            @property
            def param_dict(self) -> google.protobuf.internal.containers.MessageMap[typing.Text, global___Scalar]: ...

            def __init__(self,
                *,
                param_dict : typing.Optional[typing.Mapping[typing.Text, global___Scalar]] = ...,
                ) -> None: ...
            def ClearField(self, field_name: typing_extensions.Literal[u"param_dict",b"param_dict"]) -> None: ...
