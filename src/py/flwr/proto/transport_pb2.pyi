...
class ClientMessage(google.protobuf.message.Message):
    ...
    @property
    def error_res(self) -> global___ClientMessage.ErrorRes: ...
    ...
    def __init__(self,
        *,
        ...
        error_res : typing.Optional[global___ClientMessage.ErrorRes] = ...,
        ) -> None: ...
    def HasField(self, field_name: typing_extensions.Literal[u"disconnect",b"disconnect",u"error_res",b"error_res",u"evaluate_res",b"evaluate_res",u"fit_res",b"fit_res",u"msg",b"msg",u"parameters_res",b"parameters_res",u"properties_res",b"properties_res"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal[u"disconnect",b"disconnect",u"error_res",b"error_res",u"evaluate_res",b"evaluate_res",u"fit_res",b"fit_res",u"msg",b"msg",u"parameters_res",b"parameters_res",u"properties_res",b"properties_res"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal[u"msg",b"msg"]) -> typing_extensions.Literal["disconnect","parameters_res","fit_res","evaluate_res","properties_res","error_res"]: ...
