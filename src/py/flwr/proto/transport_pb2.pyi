...
class ClientMessage(google.protobuf.message.Message):
    ...
    class GetInfo(google.protobuf.message.Message):
        ...
        @property
        def info(self) -> google.protobuf.internal.containers.MessageMap[typing.Text, global___Scalar]: ...

        def __init__(self,
            *,
            info : typing.Optional[typing.Mapping[typing.Text, global___Scalar]] = ...,
            ) -> None: ...
