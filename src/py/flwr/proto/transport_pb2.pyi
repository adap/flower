...
class Context(google.protobuf.message.Message):
    ...
    @property
    def node_config(self) -> google.protobuf.internal.containers.MessageMap[typing.Text, global___Scalar]: ...
    @property
    def state(self) -> flwr.proto.recordset_pb2.RecordSet: ...
    @property
    def run_config(self) -> google.protobuf.internal.containers.MessageMap[typing.Text, global___Scalar]: ...
    def __init__(self,
        *,
        node_id: builtins.int = ...,
        node_config: typing.Optional[typing.Mapping[typing.Text, global___Scalar]] = ...,
        state: typing.Optional[flwr.proto.recordset_pb2.RecordSet] = ...,
        run_config: typing.Optional[typing.Mapping[typing.Text, global___Scalar]] = ...,
        ) -> None: ...
