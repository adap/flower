...
class ServerMessage(google.protobuf.message.Message):
    ...
    @property
    def ask_keys(self) -> global___ServerMessage.AskKeys: ...
    ...
    def __init__(self,
        *,
        ...
        ask_keys : typing.Optional[global___ServerMessage.AskKeys] = ...,
        ) -> None: ...
    def HasField(self, field_name: typing_extensions.Literal[u"ask_keys",b"ask_keys",u"evaluate_ins",b"evaluate_ins",u"fit_ins",b"fit_ins",u"get_parameters",b"get_parameters",u"msg",b"msg",u"reconnect",b"reconnect"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal[u"ask_keys",b"ask_keys",u"evaluate_ins",b"evaluate_ins",u"fit_ins",b"fit_ins",u"get_parameters",b"get_parameters",u"msg",b"msg",u"reconnect",b"reconnect"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal[u"msg",b"msg"]) -> typing_extensions.Literal["reconnect","get_parameters","fit_ins","evaluate_ins","ask_keys"]: ...
...
class ClientMessage(google.protobuf.message.Message):
    ...
    @property
    def ask_keys_res(self) -> global___ClientMessage.AskKeysRes: ...
    ...
    def __init__(self,
        *,
        ...
        ask_keys_res : typing.Optional[global___ClientMessage.AskKeysRes] = ...,
        ) -> None: ...
    def HasField(self, field_name: typing_extensions.Literal[u"ask_keys_res",b"ask_keys_res",u"disconnect",b"disconnect",u"evaluate_res",b"evaluate_res",u"fit_res",b"fit_res",u"msg",b"msg",u"parameters_res",b"parameters_res"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal[u"ask_keys_res",b"ask_keys_res",u"disconnect",b"disconnect",u"evaluate_res",b"evaluate_res",u"fit_res",b"fit_res",u"msg",b"msg",u"parameters_res",b"parameters_res"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal[u"msg",b"msg"]) -> typing_extensions.Literal["disconnect","parameters_res","fit_res","evaluate_res","ask_keys_res"]: ...
