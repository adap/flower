...
class _Reason(
    google___protobuf___internal___enum_type_wrapper____EnumTypeWrapper[ReasonValue]
):
...
class Parameters(google___protobuf___message___Message):
    ...
    tensors: google___protobuf___internal___containers___RepeatedScalarFieldContainer[
        builtin___bytes
    ] = ...
