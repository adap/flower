...
class ServerMessage(google.protobuf.message.Message):
    ...
    class SecaggMsg(google.protobuf.message.Message):
        ...
        def HasField(self, field_name: typing_extensions.Literal[u"ask_keys",b"ask_keys",u"msg",b"msg"]) -> builtins.bool: ...
        def ClearField(self, field_name: typing_extensions.Literal[u"ask_keys",b"ask_keys",u"msg",b"msg"]) -> None: ...
        def WhichOneof(self, oneof_group: typing_extensions.Literal[u"msg",b"msg"]) -> typing_extensions.Literal["ask_keys"]: ...

    RECONNECT_FIELD_NUMBER: builtins.int
    GET_PARAMETERS_FIELD_NUMBER: builtins.int
    FIT_INS_FIELD_NUMBER: builtins.int
    EVALUATE_INS_FIELD_NUMBER: builtins.int
    SECAGG_MSG_FIELD_NUMBER: builtins.int
    ...
    @property
    def secagg_msg(self) -> global___ServerMessage.SecaggMsg: ...
    ...
    def __init__(self,
        *,
        ...
        secagg_msg : typing.Optional[global___ServerMessage.SecaggMsg] = ...,
        ) -> None: ...
    def HasField(self, field_name: typing_extensions.Literal[u"evaluate_ins",b"evaluate_ins",u"fit_ins",b"fit_ins",u"get_parameters",b"get_parameters",u"msg",b"msg",u"reconnect",b"reconnect",u"secagg_msg",b"secagg_msg"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal[u"evaluate_ins",b"evaluate_ins",u"fit_ins",b"fit_ins",u"get_parameters",b"get_parameters",u"msg",b"msg",u"reconnect",b"reconnect",u"secagg_msg",b"secagg_msg"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal[u"msg",b"msg"]) -> typing_extensions.Literal["reconnect","get_parameters","fit_ins","evaluate_ins","secagg_msg"]: ...
...
class ClientMessage(google.protobuf.message.Message):
    ...
    class SecaggRes(google.protobuf.message.Message):
        ...
        def HasField(self, field_name: typing_extensions.Literal[u"ask_keys_res",b"ask_keys_res",u"msg",b"msg"]) -> builtins.bool: ...
        def ClearField(self, field_name: typing_extensions.Literal[u"ask_keys_res",b"ask_keys_res",u"msg",b"msg"]) -> None: ...
        def WhichOneof(self, oneof_group: typing_extensions.Literal[u"msg",b"msg"]) -> typing_extensions.Literal["ask_keys_res"]: ...
    ...
    SECAGG_RES_FIELD_NUMBER: builtins.int
    ...
    @property
    def secagg_res(self) -> global___ClientMessage.SecaggRes: ...
    ...
    def __init__(self,
        *,
        ...
        secagg_res : typing.Optional[global___ClientMessage.SecaggRes] = ...,
        ) -> None: ...
    def HasField(self, field_name: typing_extensions.Literal[u"disconnect",b"disconnect",u"evaluate_res",b"evaluate_res",u"fit_res",b"fit_res",u"msg",b"msg",u"parameters_res",b"parameters_res",u"secagg_res",b"secagg_res"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal[u"disconnect",b"disconnect",u"evaluate_res",b"evaluate_res",u"fit_res",b"fit_res",u"msg",b"msg",u"parameters_res",b"parameters_res",u"secagg_res",b"secagg_res"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal[u"msg",b"msg"]) -> typing_extensions.Literal["disconnect","parameters_res","fit_res","evaluate_res","secagg_res"]: ...
