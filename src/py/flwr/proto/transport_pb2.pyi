...
class ServerMessage(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal[u"evaluate_ins",b"evaluate_ins",u"fit_ins",b"fit_ins",u"get_parameters",b"get_parameters",u"identifier",b"identifier",u"msg",b"msg",u"properties_ins",b"properties_ins",u"reconnect",b"reconnect"]) -> None: ...
...
class ClientMessage(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal[u"disconnect",b"disconnect",u"evaluate_res",b"evaluate_res",u"fit_res",b"fit_res",u"msg",b"msg",u"parameters_res",b"parameters_res",u"properties_res",b"properties_res",u"reply_to",b"reply_to"]) -> None: ...
