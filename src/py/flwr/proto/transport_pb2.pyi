...
class ServerMessage(google.protobuf.message.Message):
    ...
    class SecAggMsg(google.protobuf.message.Message):
        ...
        def HasField(self, field_name: typing_extensions.Literal[u"ask_keys",b"ask_keys",u"msg",b"msg",u"setup_param",b"setup_param",u"share_keys",b"share_keys"]) -> builtins.bool: ...
        def ClearField(self, field_name: typing_extensions.Literal[u"ask_keys",b"ask_keys",u"msg",b"msg",u"setup_param",b"setup_param",u"share_keys",b"share_keys"]) -> None: ...
        def WhichOneof(self, oneof_group: typing_extensions.Literal[u"msg",b"msg"]) -> typing_extensions.Literal["setup_param","ask_keys","share_keys"]: ...
