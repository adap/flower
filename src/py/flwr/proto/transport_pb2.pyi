...
class ClientMessage(google.protobuf.message.Message):
    ...
    class SecAggRes(google.protobuf.message.Message):
        ...
        def HasField(self, field_name: typing_extensions.Literal[u"ask_keys_res",b"ask_keys_res",u"error_res",b"error_res",u"msg",b"msg"]) -> builtins.bool: ...
        def ClearField(self, field_name: typing_extensions.Literal[u"ask_keys_res",b"ask_keys_res",u"error_res",b"error_res",u"msg",b"msg"]) -> None: ...
        def WhichOneof(self, oneof_group: typing_extensions.Literal[u"msg",b"msg"]) -> typing_extensions.Literal["ask_keys_res","error_res"]: ...
