...
:warning: _It is preferable to show a single commmand or multilple commands and then a table/plot of the expected results, instead of showing all the commands first and then all the results/plots._
