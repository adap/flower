...
def install_from_fab(
    fab_file: Union[Path, bytes], flwr_dir: Optional[Path], no_prompt: bool = False
) -> None:
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        with zipfile.ZipFile(fab_file_archive, "r") as zipf:
            ...
            validate_and_install(tmpdir_path, flwr_dir, no_prompt)


def validate_and_install(
    project_dir: Path, flwr_dir: Optional[Path], no_prompt: bool = False
) -> None:
