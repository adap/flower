...
from flwr.common.typing import Fab, Run, StopRunException
...
def grpc_request_response(  # pylint: disable=R0913,R0914,R0915,R0917
    ...
    # If the status code is PERMISSION_DENIED, additionally raise StopRunException
    ...
    def get_fab(fab_hash: str, run_id: Union[int, None] = None) -> Fab:
        # Call FleetAPI
