...
def test_add_loss_distributed() -> None:
    ...
    # Execute
    history.add_loss_distributed(fl_round=0, loss=2.0)
...
def test_add_loss_centralized() -> None:
    ...
    # Execute
    history.add_loss_centralized(fl_round=0, loss=2.0)
...
def test_add_metrics_distributed() -> None:
    ...
    # Execute
    history.add_metrics_distributed(fl_round=0, metrics={"acc": 0.9})
...
def test_add_metrics_centralized() -> None:
    ...
    # Execute
    history.add_metrics_centralized(fl_round=0, metrics={"acc": 0.9})
