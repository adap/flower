...
# ==============================================================================
"""FedBN: Federated Learning on non-IID Features via Local Batch Normalization [Xiaoxiao et al., 2021] strategy.
...
from .aggregate import aggregate_fedbn, weighted_loss_avg
...
class FedBN(Strategy):
    ...
    def aggregate_fit(
        ...
        return aggregate_fedbn(weights_results)
