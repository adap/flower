...
class FedRDF(Strategy):
    ...
    def aggregate_fit(
        ...
        parameters_aggregated = ndarrays_to_parameters(
            self.aggregate_FedRDF(weights_results, self.threshold)
        )
    ...
    def aggregate_FedRDF(
        self, results: List[Tuple[NDArrays, int]], threshold
    ) -> NDArrays:
        ...
        if prop < threshold:
            ...
            weights_prime: NDArrays = [
                fourier_abs(layers) for layers in zip(*global_layers)
            ]
