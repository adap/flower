...
class StateTest(unittest.TestCase):
    ...
    def test_create_and_get_run(self) -> None:
        ...
        run_id = state.create_run(None, None, "Mock/mock", {"test_key": "test_value"})
    ...
    def test_store_task_ins_one(self) -> None:
        ...
        consumer_node_id = 1
        state = self.state_factory()
        run_id = state.create_run(None, None, "mock/mock", {})
    ...
    def test_get_nodes_invalid_run_id(self) -> None:
        ...
        # Prepare
        state: State = self.state_factory()
        state.create_run(None, None, "mock/mock", {})
