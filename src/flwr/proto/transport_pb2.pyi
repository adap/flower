...
class ClientMessage(google___protobuf___message___Message):
    ...
    if sys.version_info >= (3,):
        ...
        def ClearField(self, field_name: typing_extensions___Literal[u"disconnect",u"evaluate_res",u"fit_res",u"is_final",u"msg",u"parameters_res"]) -> None: ...
    else:
        ...
        def ClearField(self, field_name: typing_extensions___Literal[u"disconnect",b"disconnect",u"evaluate_res",b"evaluate_res",u"fit_res",b"fit_res",u"is_final",b"is_final",u"msg",b"msg",u"parameters_res",b"parameters_res"]) -> None: ...
