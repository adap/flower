...
class ClientMessage(google___protobuf___message___Message):
    ...
    class WeightUpdate(google___protobuf___message___Message):
        ...
        def CopyFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
        if sys.version_info >= (3,):
            def HasField(self, field_name: typing_extensions___Literal[u"info",u"weights"]) -> builtin___bool: ...
            def ClearField(self, field_name: typing_extensions___Literal[u"info",u"num_examples",u"weights"]) -> None: ...
        else:
            def HasField(self, field_name: typing_extensions___Literal[u"info",b"info",u"weights",b"weights"]) -> builtin___bool: ...
            def ClearField(self, field_name: typing_extensions___Literal[u"info",b"info",u"num_examples",b"num_examples",u"weights",b"weights"]) -> None: ...
    ...
    def CopyFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
    if sys.version_info >= (3,):
        def HasField(self, field_name: typing_extensions___Literal[u"disconnect",u"info",u"report",u"weight_update"]) -> builtin___bool: ...
        def ClearField(self, field_name: typing_extensions___Literal[u"disconnect",u"info",u"report",u"weight_update"]) -> None: ...
    else:
        def HasField(self, field_name: typing_extensions___Literal[u"disconnect",b"disconnect",u"info",b"info",u"report",b"report",u"weight_update",b"weight_update"]) -> builtin___bool: ...
        def ClearField(self, field_name: typing_extensions___Literal[u"disconnect",b"disconnect",u"info",b"info",u"report",b"report",u"weight_update",b"weight_update"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions___Literal[u"report",b"report"]) -> typing_extensions___Literal["info","disconnect","weight_update"]: ...
...
class ServerMessage(google___protobuf___message___Message):
    ...
    def CopyFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
    if sys.version_info >= (3,):
        def HasField(self, field_name: typing_extensions___Literal[u"info",u"instruction",u"reconnect",u"train"]) -> builtin___bool: ...
        def ClearField(self, field_name: typing_extensions___Literal[u"info",u"instruction",u"reconnect",u"train"]) -> None: ...
    else:
        def HasField(self, field_name: typing_extensions___Literal[u"info",b"info",u"instruction",b"instruction",u"reconnect",b"reconnect",u"train",b"train"]) -> builtin___bool: ...
        def ClearField(self, field_name: typing_extensions___Literal[u"info",b"info",u"instruction",b"instruction",u"reconnect",b"reconnect",u"train",b"train"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions___Literal[u"instruction",b"instruction"]) -> typing_extensions___Literal["info","reconnect","train"]: ...
