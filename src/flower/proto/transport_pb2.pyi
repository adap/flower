...
class ClientMessage(google___protobuf___message___Message):
    ...
    def CopyFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
    if sys.version_info >= (3,):
        def HasField(self, field_name: typing_extensions___Literal[u"info",u"report",u"weight_update"]) -> builtin___bool: ...
        def ClearField(self, field_name: typing_extensions___Literal[u"info",u"report",u"weight_update"]) -> None: ...
    else:
        def HasField(self, field_name: typing_extensions___Literal[u"info",b"info",u"report",b"report",u"weight_update",b"weight_update"]) -> builtin___bool: ...
        def ClearField(self, field_name: typing_extensions___Literal[u"info",b"info",u"report",b"report",u"weight_update",b"weight_update"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions___Literal[u"report",b"report"]) -> typing_extensions___Literal["info","weight_update"]: ...
