...
class ClientRequest(google___protobuf___message___Message):
    ...
    class Connect(google___protobuf___message___Message):
        ...
        class Info(google___protobuf___message___Message):
            ...
            if sys.version_info >= (3,):
                @classmethod
                def FromString(cls, s: builtin___bytes) -> ClientRequest.Connect.Info: ...
            else:
                @classmethod
                def FromString(cls, s: typing___Union[builtin___bytes, builtin___buffer, builtin___unicode]) -> ClientRequest.Connect.Info: ...
            def MergeFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
            def CopyFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
            if sys.version_info >= (3,):
        ...
        @property
        def info(self) -> ClientRequest.Connect.Info: ...

        def __init__(self,
            *,
            info : typing___Optional[ClientRequest.Connect.Info] = None,
            ) -> None: ...
        if sys.version_info >= (3,):
            @classmethod
