...
class ServerMessage(google___protobuf___message___Message):
    ...
    def CopyFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
    if sys.version_info >= (3,):
        def HasField(self, field_name: typing_extensions___Literal[u"evaluate",u"fit_ins",u"get_properties",u"get_weights",u"msg",u"reconnect"]) -> builtin___bool: ...
        def ClearField(self, field_name: typing_extensions___Literal[u"evaluate",u"fit_ins",u"get_properties",u"get_weights",u"msg",u"reconnect"]) -> None: ...
    else:
        def HasField(self, field_name: typing_extensions___Literal[u"evaluate",b"evaluate",u"fit_ins",b"fit_ins",u"get_properties",b"get_properties",u"get_weights",b"get_weights",u"msg",b"msg",u"reconnect",b"reconnect"]) -> builtin___bool: ...
        def ClearField(self, field_name: typing_extensions___Literal[u"evaluate",b"evaluate",u"fit_ins",b"fit_ins",u"get_properties",b"get_properties",u"get_weights",b"get_weights",u"msg",b"msg",u"reconnect",b"reconnect"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions___Literal[u"msg",b"msg"]) -> typing_extensions___Literal["reconnect","get_weights","fit_ins","evaluate","get_properties"]: ...
...
class ClientMessage(google___protobuf___message___Message):
    ...
    def CopyFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
    if sys.version_info >= (3,):
        def HasField(self, field_name: typing_extensions___Literal[u"disconnect",u"evaluate",u"fit_res",u"get_properties",u"get_weights",u"msg"]) -> builtin___bool: ...
        def ClearField(self, field_name: typing_extensions___Literal[u"disconnect",u"evaluate",u"fit_res",u"get_properties",u"get_weights",u"msg"]) -> None: ...
    else:
        def HasField(self, field_name: typing_extensions___Literal[u"disconnect",b"disconnect",u"evaluate",b"evaluate",u"fit_res",b"fit_res",u"get_properties",b"get_properties",u"get_weights",b"get_weights",u"msg",b"msg"]) -> builtin___bool: ...
        def ClearField(self, field_name: typing_extensions___Literal[u"disconnect",b"disconnect",u"evaluate",b"evaluate",u"fit_res",b"fit_res",u"get_properties",b"get_properties",u"get_weights",b"get_weights",u"msg",b"msg"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions___Literal[u"msg",b"msg"]) -> typing_extensions___Literal["disconnect","get_weights","fit_res","evaluate","get_properties"]: ...
