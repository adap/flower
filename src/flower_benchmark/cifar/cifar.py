...
def ds_from_nda(nda_x: np.ndarray, nda_y: np.ndarray):
    """Create TensorDataset from NumPy data and labels."""
    tensor_x = torch.Tensor(nda_x)
    tensor_y = torch.Tensor(nda_y)
