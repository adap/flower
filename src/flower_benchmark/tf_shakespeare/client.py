...
def main() -> None:
    ...
    # Load model
    model = stacked_lstm(input_len = 80, hidden_size = 256, num_classes = 80, embedding_size = 80, seed = SEED)
    ...
    # Start client
    client = ShakespeareClient(client_setting.cid, model, xy_train, xy_test, client_setting.delay_factor, 80)
