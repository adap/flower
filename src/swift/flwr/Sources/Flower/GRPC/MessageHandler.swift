...
func handle(client: Client, serverMsg: Flwr_Proto_ServerMessage) throws -> (
  Flwr_Proto_ClientMessage, Int, Bool
) {
...
func reconnect(reconnectMsg: Flwr_Proto_ServerMessage.ReconnectIns) -> (
  Flwr_Proto_ClientMessage, Int
) {
...
func getProperties(client: Client, propertiesMsg: Flwr_Proto_ServerMessage.GetPropertiesIns)
  -> Flwr_Proto_ClientMessage
{
...
func evaluate(client: Client, evaluateMsg: Flwr_Proto_ServerMessage.EvaluateIns)
  -> Flwr_Proto_ClientMessage
{
