...
import flwr_experimental.benchmark.tf_cifar.settings as tf_cifar_settings
import flwr_experimental.benchmark.tf_fashion_mnist.settings as tf_fashion_mnist_settings
import flwr_experimental.benchmark.tf_hotkey.settings as tf_hotkey_settings
from flwr.logger import configure, log
from flwr_experimental.benchmark import command
...
def configure_cluster(
    ...
    if adapter == "docker":
        ...
        adapter_instance = EC2Adapter(
            ...
            tags=[
                ("Purpose", "flwr_experimental.benchmark"),
