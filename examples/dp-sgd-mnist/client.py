...
def main(args) -> None:
    ...
    (x_train, y_train), (x_test, y_test) = common.load(
    ...
    if args.dpsgd:
        print("Privacy Lost: ", PRIVACY_LOSS)


if __name__ == '__main__':
    parser = argparse.ArgumentParser(description="Flower Client")
    parser.add_argument(
        '--num-clients', default=2, type=int,
    ...
    parser.add_argument(
        '--local-epochs', default=1, type=int,
    ...
    parser.add_argument(
        '--learning-rate', default=0.15, type=float,
        help='Learning rate for training'
    )
    # DPSGD specific arguments
    parser.add_argument(
        '--dpsgd', default=False, type=bool,
        help='If True, train with DP-SGD. If False, '
        'train with vanilla SGD.'
    )
    parser.add_argument(
        '--l2-norm-clip', default=1.0, type=float,
        help='Clipping norm'
    )
    parser.add_argument(
        '--noise-multiplier', default=1.1, type=float,
        help='Ratio of the standard deviation to the clipping norm'
    )
    parser.add_argument(
        '--microbatches', default=32, type=int,
