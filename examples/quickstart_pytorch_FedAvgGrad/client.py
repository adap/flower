...
def main():
    ...
    class CifarClient(fl.client.NumPyClient):
        ...
        def fit(self, parameters, config):
            ...
            #current_parameters contains the parameters before the training processs
            ...
            #difference_in_parameters contains the difference in parameters between current_parameters and new_parameters
            difference_in_parameters = np.subtract(current_parameters, new_parameters)
 

            return difference_in_parameters, len(trainloader), {}
