...
![](_static/opacus_fine_tun.png)
---
#### Image generated after fine-tuning with sample-level differential privacy using Opacus.

![](_static/laplace_fine_tun.png)
---
#### Image generated after fine-tuning with output-level differential privacy.
## Note: 
...
Trainable parameters: 648192
 ...
 Using base model: segmind/tiny-sd
 Training LoRA parameters only (108 layers)
...
(ClientAppActor pid=73271) Partition 0: 2868 training samples, 717 test samples
...
(ClientAppActor pid=73270) Partition 1: 2868 training samples, 717 test samples
(ClientAppActor pid=73270) Trainable parameters: 648192
...
(ClientAppActor pid=73271) Partition 1: 2868 training samples, 717 test samples
...
(ClientAppActor pid=73271) Trainable parameters: 648192
(ClientAppActor pid=73270) Partition 0: 2868 training samples, 717 test samples
