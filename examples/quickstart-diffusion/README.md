...
First, create and activate a virtual environment (recommended to avoid dependency conflicts):

```bash
# Create environment with Python 3.9 (you may also use 3.10 or 3.11)
