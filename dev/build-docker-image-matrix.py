...
def build_complete_matrix(flwr_version: str):
...
def build_ubuntu_python_latest_matrix(flwr_version: str):
...
if __name__ == "__main__":
    ...
    if simple:
        base_images, binary_images = build_ubuntu_python_latest_matrix(flwr_version)
    else:
        base_images, binary_images = build_complete_matrix(flwr_version)
