...
python3.7 -m pip install -U pip==20.1.1 setuptools==47.3.1
python3.7 -m pip install -U numpy==1.18.1 grpcio==1.27.2 google==2.0.3 protobuf==3.12.0 tensorflow-cpu==2.1.0 boto3==1.12.36 boto3_type_annotations==0.3.1 paramiko==2.7.1 docker==4.2.0 matplotlib==3.2.1 torch==1.5.1 torchvision==0.6.1
